...
const BASE_URL = 'https://doctor-api-v1.onrender.com/users';
...
export const fetchDoctors = createAsyncThunk('doctors/fetchDoctors', async () => {
  try {
    const response = await axios.get('https://doctor-api-v1.onrender.com/users?role=doctor', {
      headers: {
...
export const deleteDoctor = createAsyncThunk(
  ...
  async (doctorId, { rejectWithValue }) => {
    try {
      await axios.delete(`https://doctor-api-v1.onrender.com/users/${doctorId}`, {
        headers: {
          Authorization: sessionStorage.getItem('authToken'),
        },
      });
